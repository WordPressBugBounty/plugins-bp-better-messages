...
function better_messages_design_outline_note() {
    return _x( 'Only the Outlined design draws an outline. Chat rooms that pick it in their own settings still follow this', 'Settings page', 'bp-better-messages' );
}
                    ...
                    array(
                        ...
                        'controls'    => array(
                            ...
                            array(
                                ...
                                'kind'        => 'color',
                                'source'      => 'token',
                                'label'       => _x( 'Links', 'Settings page', 'bp-better-messages' ),
                                'default'     => '17, 24, 39',
                                'dark'        => '241, 245, 249',
                                'help'        => _x( 'Links in messages under the Outlined and Classic designs. Follows the text until you set it', 'Settings page', 'bp-better-messages' ),
                                'formula'     => array( 'same', '--bm-color-text-primary' ),
                                'appliesWhen' => array( 'bubbleFill' => array( 'outline', 'none' ) ),
                                'appliesNote' => _x( 'Not used by the Bubbles design, where each side has its own. Chat rooms that pick Outlined or Classic in their own settings still follow it', 'Settings page', 'bp-better-messages' ),
                            ),
                        ),
                    ),
                    ...
                    array(
                        ...
                        'controls' => array(
                            array(
                                ...
                                'notes'   => array(
                                    array(
                                        'when' => array( 'bubbleFill' => array( 'outline' ) ),
                                        'note' => _x( 'No bubble is filled in this design. This colours the box of your deleted and encrypted messages, and the outline until you set one', 'Settings page', 'bp-better-messages' ),
                                    ),
                                    array(
                                        'when' => array( 'bubbleFill' => array( 'none' ) ),
                                        'note' => _x( 'Classic draws no bubble. This colours the box of your deleted and encrypted messages', 'Settings page', 'bp-better-messages' ),
                                    ),
                                ),
                            ),
                            array(
                                'id'          => '--bm-color-bubble-self-outline',
                                'kind'        => 'color',
                                'source'      => 'token',
                                'label'       => _x( 'Outline', 'Settings page', 'bp-better-messages' ),
                                'default'     => '37, 99, 235',
                                'dark'        => '37, 99, 235',
                                'help'        => _x( 'The outline around your messages under the Outlined design. Follows the background until you set it', 'Settings page', 'bp-better-messages' ),
                                'formula'     => array( 'same', '--bm-color-bubble-self-bg' ),
                                'appliesWhen' => array( 'bubbleFill' => array( 'outline' ) ),
                                'appliesNote' => better_messages_design_outline_note(),
                            ),
                            array(
                                ...
                                'notes'   => array(
                                    array(
                                        'when' => array( 'bubbleFill' => array( 'outline', 'none' ) ),
                                        'note' => _x( 'Your messages use the conversation text in this design. This colours your reactions and your deleted and encrypted messages', 'Settings page', 'bp-better-messages' ),
                                    ),
                                ),
                            ),
                            array(
                            ...
                            array(
                                'id'          => '--bm-color-bubble-self-link',
                                'kind'        => 'color',
                                'source'      => 'token',
                                'label'       => _x( 'Links', 'Settings page', 'bp-better-messages' ),
                                'default'     => '255, 255, 255',
                                'dark'        => '255, 255, 255',
                                'help'        => _x( 'Links in your messages. Follows the text until you set it', 'Settings page', 'bp-better-messages' ),
                                'formula'     => array( 'same', '--bm-color-bubble-self-text' ),
                        ...
                        'controls' => array(
                            array(
                                ...
                                'notes'   => array(
                                    array(
                                        'when' => array( 'bubbleFill' => array( 'outline' ) ),
                                        'note' => _x( 'No bubble is filled in this design. This colours deleted and encrypted messages and the typing indicator under the last message', 'Settings page', 'bp-better-messages' ),
                                    ),
                                    array(
                                        'when' => array( 'bubbleFill' => array( 'none' ) ),
                                        'note' => _x( 'Classic draws no bubble. This colours deleted and encrypted messages and the typing indicator under the last message', 'Settings page', 'bp-better-messages' ),
                                    ),
                                ),
                            ),
                            array(
                                'id'          => '--bm-color-bubble-other-outline',
                                'kind'        => 'color',
                                'source'      => 'token',
                                'label'       => _x( 'Outline', 'Settings page', 'bp-better-messages' ),
                                'default'     => '229, 231, 235',
                                'dark'        => '51, 65, 95',
                                'help'        => _x( 'The outline around other people\'s messages under the Outlined design. Follows the conversation border until you set it', 'Settings page', 'bp-better-messages' ),
                                'formula'     => array( 'same', '--bm-color-border' ),
                                'appliesWhen' => array( 'bubbleFill' => array( 'outline' ) ),
                                'appliesNote' => better_messages_design_outline_note(),
                            ),
                            ...
                            array(
                                'id'          => '--bm-color-bubble-other-link',
                                'kind'        => 'color',
                                'source'      => 'token',
                                'label'       => _x( 'Links', 'Settings page', 'bp-better-messages' ),
                                'default'     => '17, 24, 39',
                                'dark'        => '241, 245, 249',
                                'help'        => _x( 'Links in other people\'s messages. Follows the text until you set it', 'Settings page', 'bp-better-messages' ),
                                'formula'     => array( 'same', '--bm-color-bubble-other-text' ),
                                'appliesWhen' => array( 'bubbleFill' => array( 'filled' ) ),
                                'appliesNote' => better_messages_design_bubble_fill_note(),
                            ),
                        ),
                ...
                array(
                    ...
                    'controls'    => array(
                        ...
                        array(
                            ...
                            'kind'      => 'switch',
                            'source'    => 'option',
                            'label'     => _x( 'Menu button on conversations', 'Settings page', 'bp-better-messages' ),
                            'help'      => _x( 'A ⋯ button on each row of the conversations list, shown while the pointer is over it. It opens the same menu as a right click. Phones have their own switch under Mobile', 'Settings page', 'bp-better-messages' ),
                            'default'   => true,
                            'bodyClass' => 'bm-thread-menu-',
                            'previewSurface' => 'desktop',
                            'previewView'    => 'list',
                        ),
                        array(
            ...
            'groups'      => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'id'        => 'miniChatsPrivateMessages',
                            'scriptVar' => 'miniChatsPrivateMessages',
                            'kind'      => 'switch',
                            'source'    => 'option',
                            'requires'  => 'websocket',
                            'label'     => _x( 'Private messages from a conversation', 'Settings page', 'bp-better-messages' ),
                            'help'      => _x( 'Private Message on a participant or on a message opens the new conversation in a mini chat, so the one it was started from, a chat room for example, stays open. Phones open it in the messenger as before', 'Settings page', 'bp-better-messages' ),
                            'default'   => false,
        ...
        array(
            ...
            'groups'      => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'id'          => 'mobileThreadMenuButton',
                            'kind'        => 'switch',
                            'source'      => 'option',
                            'previewView' => 'list',
                            'label'       => _x( 'Menu button on conversations', 'Settings page', 'bp-better-messages' ),
                            'help'        => _x( 'A ⋯ button on each row of the conversations list, always shown. It opens the same menu as a long press', 'Settings page', 'bp-better-messages' ),
                            'default'     => true,
                            'bodyClass'   => 'bm-thread-menu-mobile-',
                        ),
                    ),
                ),
            ...
            'groups'      => array(
                array(
                    'controls' => array(
                        ...
                        array(
                            'id'      => '--bm-color-bubble-self-seen',
                            'hidden'  => true,
                            'kind'    => 'color',
                            'source'  => 'token',
                            'label'   => 'Seen tick on own messages',
                            'default' => '255, 255, 255',
                            'dark'    => '255, 255, 255',
                            'formula' => array( 'readable', '--bm-color-bubble-self-bg', '--bm-color-accent', '--bm-color-bubble-self-text', 3 ),
                        ),
                        array(
